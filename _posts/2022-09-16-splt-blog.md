...
It was during this exploration that I encountered DeepMind's [seminal paper on AlphaZero.](https://arxiv.org/abs/1712.01815) Instantly, I recognized the potential of the AlphaZero algorithm to this be applied to SPL-T - after all, compared to a 19x19 board, a single player game on an 8x16 board seemed doable. Furthermore, it would allow me to go beyond my feeble ability to play the game - by using a human-"expert" generated algorithm, performance would be inherently limited by my capabilities. By using reinforcement learning, my own limitations would no longer apply and the algorithm could get closer to the true ceiling of perfect SPL-T play.
