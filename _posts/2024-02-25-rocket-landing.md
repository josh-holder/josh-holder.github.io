...
Many thanks to Sam Buckner for consulting on this post - The University of Washington has some of the world's foremost researchers on this topic. For a more rigorous introduction to SCP (and lossless convexification, which I didn't cover in this post), I would recommend [this fantastic tutorial article](https://arxiv.org/pdf/2106.09125.pdf).
